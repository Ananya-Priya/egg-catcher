...
function preload(){
  ...
  eggGroup = new Group();
  congimg=loadImage("cong.jpg");
  backintroimage=loadImage("backgr.jpg");
...
function setup() {
 ...
 background(backintroimage);
  ...
  textFont("Impact");
  text("WELCOME TO EGG CATCHER",500,200);
  text("PRESS 1 FOR SINGLE PLAYERE",500,250)
  text("PRESS 2 FOR DOUBLED PLAYERE",500,300)
...
function draw() {
  ...
  if(gameMode==='one')
  {
    if(gameStateai===PLAYai)
    {
      ...
      textSize(25);
      fill("black");
      text("player1 score:" +player1scoreai,100,50);
      text("player2 score:" +player2scoreai,100,100);
    ...
    if(gameStateai===ENDai)
  {
    clear();
       ...
       if(levelai==="one" )
       {
        fill("red");
        textSize(35)
        text("THE WINNER OF LEVEL1 IS : "+winnerai,450,450)
  
        fill("green")
        textSize(30)
        text("PRESS SPACEKEY TO ENTER LEVEL2",400,500)
       ...
       if(levelai==="two" && gameStateai===ENDai)
       {
        fill("red");
        textSize(35)
        text("THE WINNER OF LEVEL2 IS : "+winnerai,450,450)
  
        fill("green")
        textSize(30)
        text("PRESS SPACEKEY TO ENTER LEVEL3",400,500)
       ...
       if(levelai==="third" && gameStateai===ENDai)
       {
        ...
        fill("red");
        textSize(35)
        text("THE WINNER OF LEVEL3 IS : "+winnerai,450,450)
