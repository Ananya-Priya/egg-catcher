class Game{
    ...
    play(){
     ...
     if(level==="one" )
     {
      fill("red");
      textSize(35)
      text("THE WINNER OF LEVEL1 IS : "+winner,450,450)

      fill("green")
      textSize(30)
      text("PRESS SPACEKEY TO ENTER LEVEL2",450,500)
     ...
     if(level==="two" && gameState===2 )
     {
      fill("red");
      textSize(35)
      text("THE WINNER OF LEVEL2 IS : "+winner,450,450)

      fill("green")
      textSize(30)
      text("PRESS SPACEKEY TO ENTER LEVEL3",450,500)
     ...
     if(level==="third" && gameState===2 )
     {
      ...
      fill("red");
      textSize(35)
      text("THE WINNER OF LEVEL3 IS : "+winner,450,450)
